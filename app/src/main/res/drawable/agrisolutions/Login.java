    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       mAuth = FirebaseAuth.getInstance();
        ...
        if (mAuth.getCurrentUser() != null) {
            startActivity(new Intent(Login.this, UserMainDashboard.class));
            finish();
        }
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if (task.isSuccessful()) {
                        if (radiobtnUser.isChecked()) {
                            ...
                            reference.orderByChild("email").equalTo(email).addValueEventListener(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                    if (dataSnapshot.exists()) {
                                        ...
                                        Intent intent = new Intent(getApplicationContext(), UserMainDashboard.class);
                                        startActivity(intent);
                                        finish();
                                    } else {
                            ...
                            reference.orderByChild("ExpertEmail").equalTo(email).addValueEventListener(new ValueEventListener() {
                                @Override
                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                    if (dataSnapshot.exists()) {
                                        loadingBar.dismiss();
