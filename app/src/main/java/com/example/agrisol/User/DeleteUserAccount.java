...
public class DeleteUserAccount extends AppCompatActivity {
    ...
    public void showAlertDialog() {
        AlertDialog.Builder builder =
                new AlertDialog.Builder(DeleteUserAccount.this);
        ...
        if (currentUser != null) {
            currentUser.delete().addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    if (task.isSuccessful()) {
                        DatabaseReference reference = FirebaseDatabase.getInstance().getReference("Users").child("User").child(currentUser.getUid());
